...
//
#ifndef _freeBinaryFastExtor_hh_
#define _freeBinaryFastExtor_hh_
#include "instruction.hh"

class FreeBinaryFastExtor : public Instruction
{
  NO_COPYING(FreeBinaryFastExtor);
...
private:
  ...
  FreeNet* net;  // discrimination net for our symbol
  //
