...
//
//      Class for generators that apply a single named rule.
//
#ifndef _applicationSetGenerator_hh_
#define _applicationSetGenerator_hh_
#include "setGenerator.hh"
#include "rewriteSearchState.hh"
#include "cachedDag.hh"

class ApplicationSetGenerator : public SetGenerator
{
public:
