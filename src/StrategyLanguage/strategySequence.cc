...
StrategySequence::StrategySequence(const Vector<StrategyExpression*> strategies)
...
SetGenerator*
StrategySequence::execute(DagNode* subject, RewritingContext& context)
{
  return new SequenceSetGenerator(subject, context, strategies);
}
