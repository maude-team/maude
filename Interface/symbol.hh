...
public:
  ...
  //
  bool rangeSortNeverLeqThan(Sort* sort); // should be virtual since always false for BranchSymbol
  bool rangeSortAlwaysLeqThan(Sort* sort);  // always false for BranchSymbol
  bool domainSortAlwaysLeqThan(Sort* sort, int argNr); // always false for Branch, Equality symbols
